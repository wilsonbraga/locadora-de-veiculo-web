package br.com.sistema.modelolazy;
...
public class LazyCarroDataModel extends LazyDataModel<Carro> implements Serializable {
	...
	public List<Carro> load(int first, int pageSize, String sortField, SortOrder sortOrder,
		...
		// Se fizer um filtro, então é importante encontrar total de carros para
		// o filtro
		// Como nesse exemplo não temos filtro, então buscamos a quantidade
		// total de carros para a paginação
		// Não pode ser o tamanho da lista carros pois a mesma está limitada ao
		// pageSize
